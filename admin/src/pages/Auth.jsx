      ...
      <div className="info_section">
        ...
        <div className="uses">
          ...
          <dl>
            ...
            <dd>Admins must sign in or sign up to access the panel.</dd>

            <dt>Upload Assets</dt>
            <dd>Upload 3D (.glb/.fbx) or 2D assets to marketplace.</dd>

            <dt>Manage Assets</dt>
            <dd>Edit, delete, or hide assets from the website.</dd>

            <dt>View and Edit 3D modle</dt>
            <dd>View and Edit your 3D modle file. </dd>
          </dl>
        </div>
      </div>
